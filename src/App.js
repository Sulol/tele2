...
import Tarif from './components/components/tarifs/Tarifs'
...
export default function App() {
    ...
    const tarifs = [
        ...
        {title: "Мой разговор", price: 200, text: "безлимит на Tele2 России",
         minutes: 200, internet: "2 ГБ интернета"}
    ]
    ...
    return (
        <div className="flex">
            <Tarif id={tarifs[0].id} title={tarifs[0].title} price={tarifs[0].price} text={tarifs[0].text}
             ...
             <Tarif title={tarifs[3].title} price={tarifs[3].price} text={tarifs[3].text}
             minutes={tarifs[3].minutes} internet={tarifs[3].internet}/>
        </div>
    )
}
